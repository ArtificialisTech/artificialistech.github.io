        ...
        <footer id="contact" class="footer">
            ...
            <div class="footer-bottom" style="display: flex; flex-direction: column; align-items: center; gap: 0.5rem; text-align: center;">
                ...
                <div class="legal-info" style="font-size: 0.85rem; color: var(--text-muted); margin-top: 0.5rem; line-height: 1.6;">
                    <p><strong>Ragione Sociale:</strong> Artificialis srl | <strong>Partita IVA:</strong> 03476380732 | <strong>Capitale Sociale:</strong> 2500€</p>
                    <p><strong>Sede Legale:</strong> VIA DEL TRATTURELLO TARANTINO</p>
                    <p><strong>PEC:</strong> <a href="mailto:artificialis0@pec.it" style="color: inherit; text-decoration: underline;">artificialis0@pec.it</a> | <strong>Ufficio del Registro:</strong> TA - 259874</p>
                </div>
            </div>
        </footer>
        `;
